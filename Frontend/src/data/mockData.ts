...
export const purchaseOrders: PurchaseOrder[] = [
  { id: 'PO-001', supplierId: 'S001', supplierName: 'TechParts Co.', status: 'RECEIVED', totalAmount: 1499.90, createdAt: new Date('2024-11-01'), estimatedArrivalDate: '2024-11-10' },
  { id: 'PO-002', supplierId: 'S002', supplierName: 'Global Electronics Ltd.', status: 'RECEIVED', totalAmount: 2999.80, createdAt: new Date('2024-11-15'), estimatedArrivalDate: '2024-11-25' },
  { id: 'PO-003', supplierId: 'S003', supplierName: 'Premium Peripherals Inc.', status: 'PENDING', totalAmount: 899.85, createdAt: new Date('2024-12-01'), estimatedArrivalDate: '2024-12-15' },
  { id: 'PO-004', supplierId: 'S001', supplierName: 'TechParts Co.', status: 'PENDING', totalAmount: 599.94, createdAt: new Date('2024-12-20') },
...
export const purchaseOrderItems: PurchaseOrderItem[] = [
  { id: 'POI-001', purchaseOrderId: 'PO-001', productVariantId: 'V001', productName: 'Wireless Mouse', variantName: 'Black', quantity: 50, unitPrice: 29.99 },
  { id: 'POI-002', purchaseOrderId: 'PO-002', productVariantId: 'V003', productName: 'Mechanical Keyboard', variantName: 'Blue Switch', quantity: 20, unitPrice: 149.99 },
  { id: 'POI-003', purchaseOrderId: 'PO-003', productVariantId: 'V005', productName: 'USB-C Hub', variantName: 'Space Gray', quantity: 15, unitPrice: 59.99 },
  { id: 'POI-004', purchaseOrderId: 'PO-004', productVariantId: 'V002', productName: 'Wireless Mouse', variantName: 'White', quantity: 20, unitPrice: 29.99 },
  { id: 'POI-005', purchaseOrderId: 'PO-002', productVariantId: 'V007', productName: 'Webcam HD', variantName: 'Standard', quantity: 10, unitPrice: 89.99 },
];
